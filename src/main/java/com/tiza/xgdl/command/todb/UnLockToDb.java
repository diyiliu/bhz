...
/**
 * Description: 解锁指令 到 数据库
 * Author: Wolf
 * Created:Wolf-(2014-11-04 14:51)
 * Version: 1.0
 * Updated:
 */
public class UnLockToDb extends BaseToDbBiz implements Runnable {
    ...
    private static final int cmdId = 0x02;

    private String sql;
    private Object[] params;
    private static final int respCmdId = 0x12;

    public UnLockToDb(QueryRunner runner) {
        super(runner);
        this.stop = true;
    }
    ...
    public int insertToDb() {
        ...
        if (this.insertId != this.errorInsertId) {
            new Thread(this, "UnLockToDb--" + this.insertId).start();
        }
